/* ===================== EconoLearn - main.jsx (final v7) ===================== */
const { useEffect, useMemo, useRef, useState } = React;

/* ----------------- Global version to bust cache ----------------- */
const APP_VERSION = '7'; // bump when you deploy
...
const glassBtn  = (extra="") => `px-4 py-2 rounded-lg border border-white/40 bg-white/60 hover:bg-white/75
...
/* ----------------- FancySelect (auto flips, scrollable) ----------------- */
...
const App = () => {
  ...
  useEffect(() => {
    fetch('questions.json?v=' + APP_VERSION)
                ...
                <div className={`${glassCard} animate-slide`}>
                  ...
                  <div className="mt-6 flex items-center gap-3">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {/* Mark for Review coloring fixed */}
                      <button
